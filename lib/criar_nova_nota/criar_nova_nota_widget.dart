...
import 'criar_nova_nota_model.dart';
export 'criar_nova_nota_model.dart';

class CriarNovaNotaWidget extends StatefulWidget {
  const CriarNovaNotaWidget({super.key});

  @override
  State<CriarNovaNotaWidget> createState() => _CriarNovaNotaWidgetState();
}

class _CriarNovaNotaWidgetState extends State<CriarNovaNotaWidget> {
  late CriarNovaNotaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarNovaNotaModel());
