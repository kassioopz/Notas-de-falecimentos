...
class UsersRecord extends FirestoreRecord {
  ...
  // "linkdosplanos" field.
  String? _linkdosplanos;
  String get linkdosplanos => _linkdosplanos ?? '';
  bool hasLinkdosplanos() => _linkdosplanos != null;
  ...
  void _initializeFields() {
    ...
    _linkdosplanos = snapshotData['linkdosplanos'] as String?;
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.linkdosplanos == e2?.linkdosplanos &&
        e1?.videos == e2?.videos &&
        e1?.adm == e2?.adm;
  }
