...
class PostsRecord extends FirestoreRecord {
  ...
  // "Post_fotos" field.
  List<String>? _postFotos;
  List<String> get postFotos => _postFotos ?? const [];
  bool hasPostFotos() => _postFotos != null;
  ...
  void _initializeFields() {
    ...
    _postFotos = getDataList(snapshotData['Post_fotos']);
  }
...
class PostsRecordDocumentEquality implements Equality<PostsRecord> {
  ...
  bool equals(PostsRecord? e1, PostsRecord? e2) {
    ...
    return e1?.postPhoto == e2?.postPhoto &&
        ...
        listEquality.equals(e1?.postFotos, e2?.postFotos);
  }
