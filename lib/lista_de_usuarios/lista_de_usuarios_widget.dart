...
import 'lista_de_usuarios_model.dart';
export 'lista_de_usuarios_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> listaDeUsuariosUsersRecordList = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 12.0, 4.0),
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      triggerPushNotification(
                        ...
                        userRefs: listaDeUsuariosUsersRecordList
                            .where((e) => e.adm == true)
                            .toList()
                            .map((e) => e.reference)
                            .toList(),
                        initialPageName: 'meuperfil',
                        parameterData: {
                          'perfil':
                              listaDeUsuariosUsersRecordList.first.reference.id,
                        },
                      );
                      setState(() {
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final lista = listaDeUsuariosUsersRecordList
                                        .map((e) => e)
                                        .toList();
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        'EX Agora você pode postar as notas de falecimento.',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Inter',
