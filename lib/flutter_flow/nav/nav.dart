...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? FeedWidget() : FeedWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) =>
              appStateNotifier.loggedIn ? FeedWidget() : FeedWidget(),
          routes: [
            FFRoute(
              name: 'meuperfil',
              path: 'meuperfil',
            ...
            FFRoute(
              name: 'postDetalhes',
              path: 'postDetalhes',
              builder: (context, params) => PostDetalhesWidget(
            ...
            FFRoute(
              name: 'novopost',
              path: 'novopost',
              builder: (context, params) => NovopostWidget(
                uploadedFile: params.getParam(
                  'uploadedFile',
            ...
            FFRoute(
              name: 'avisos',
              path: 'avisos',
              builder: (context, params) => AvisosWidget(),
            ),
            FFRoute(
              name: 'post_video_detalhes',
              path: 'postVideoDetalhes',
              asyncParams: {
                'post': getDoc(['videos'], VideosRecord.fromSnapshot),
              },
              builder: (context, params) => PostVideoDetalhesWidget(
                post: params.getParam(
                  'post',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'CriarNovaNota',
              path: 'criarNovaNota',
              builder: (context, params) => CriarNovaNotaWidget(),
            )
